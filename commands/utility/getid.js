...
module.exports = {
	...
	async execute(interaction) {
		...
		qr_png.pipe(fs.createWriteStream("./public/" + pngname));
...
const templateEmbed = (pngname, tinylink) => {
	...
	.setTimestamp()
	.setFooter({ text: 'Some footer text here', iconURL: 'https://pbs.twimg.com/profile_images/1499065754313887747/_YAZWd_X_400x400.jpg' })
};